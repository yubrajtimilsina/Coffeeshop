...
function buyButtonClicked() {
    ...
    for (var i = 0; i < cartBoxes.length; i++) {
        ...
        var priceValue = parseFloat(price.toString().replace('Rs', '').replace(',', ''));
    ...
    // Round the total to the nearest whole number and format it as Rs.XXX
    total = "Rs." + Math.round(total);

    // Add the total to the orderDetails array
    orderDetails.push({ total: total });
...
function updateTotal() {
    ...
    // Display the total in the format Rs.XXX
