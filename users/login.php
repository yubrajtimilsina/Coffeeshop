...
<html>
    <head>
        ...
        <title>Kaski Kot Coffee | Login Form</title>
    ...
    <body>
        <?php
            ...
            if (isset($_POST['username'])) {
                ...
                // Check if user exists in the database (without hashing)
        ...
        ?>
            <form class="form" method="post" name="login">
                ...
                <div id="g_id_onload"
                    ...
                    data-context="signin"
                    data-ux_mode="popup"
                    data-login_uri="https://kaskikotcoffeeshop.infinityfreeapp.com"
